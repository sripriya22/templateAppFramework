classdef AbstractController < handle
    ...
    methods (Access=protected)
        ...
        function onModelChanged(obj, ~, eventData)
            ...
            % Get the property value and convert inf/-inf for JavaScript
            propertyValue = affectedObj.(propertyName);
            if isa(affectedObj, 'server.model.BaseObject')
                propertyValue = server.model.BaseObject.convertInfsForJS(propertyValue);
            end
